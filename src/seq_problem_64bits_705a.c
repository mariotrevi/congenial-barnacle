...
int main(void)
{
  ...
  for(i=1; i<= 60; i++)
  {
    ...
    test_number =  18446559485146739168;
    n = 18446559485146739168;

    flag=1;


//      1844655,9485146739168


//      1844655,7382499754464



//      1844655,0353846067680



//     184465,50346213425710


//     184466,01306974262224
...
for(k=0; k< 8; k=k+2)
{
   ...
   test_number = test_number | 9223372036854775808;

   test_number = test_number | 4611686018427387904;

   test_number = test_number | 4593671619917905920;
   
   test_number = test_number | 16888498602639360 ;
